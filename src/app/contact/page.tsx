...
import FloatingLeaves from "@/components/three/objects/FloatingLeaves";
...
export default function Page() {
  return (
    <main className="relative min-h-screen bg-linear-to-br from-stone-50 via-emerald-50/30 to-green-50/40 overflow-hidden">
