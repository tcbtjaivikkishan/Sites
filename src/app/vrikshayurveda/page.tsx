import NutrientSection from "@/components/vrikshayurveda/NutrientSection";
...
export const metadata = {
  title: "TCBT वृक्षायुर्वेद विज्ञान",
  description: "पोषक तत्वों की कमी एवं उनका प्राकृतिक समाधान",
};
      ...
      <section className="relative py-20 md:py-32 px-6 text-center">
        <div className="max-w-5xl mx-auto space-y-6">
          ...
          <h1 className="space-y-2">
            ...
            <div className="text-4xl md:text-5xl lg:text-6xl font-bold text-stone-800 animate-slideUp" style={{ animationDelay: '0.1s', animationFillMode: 'backwards' }}>
              वृक्षायुर्वेद विज्ञान
            </div>
          </h1>

          { }
          <p className="text-lg md:text-xl text-stone-600 max-w-2xl mx-auto leading-relaxed animate-slideUp" style={{ animationDelay: '0.2s', animationFillMode: 'backwards' }}>
